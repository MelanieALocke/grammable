...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#destroy action" do
    it "shouldn't let users who didn't create gram destroy gram" do
    ...
    it "should return a 404 message if gram cannot be found" do
      user = FactoryBot.create(:user)
      sign_in user
  ...
  describe "grams#update action" do
    it "shouldn't let users who didn't create gram update gram" do
      gram = FactoryBot.create(:gram)
      user = FactoryBot.create(:user)
      sign_in user
